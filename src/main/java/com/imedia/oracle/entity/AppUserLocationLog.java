...
/**
 * The persistent class for the APP_USER_LOCATION_LOGS database table.
 */
@Entity
@Table(name = "APP_USER_LOCATION_LOGS")
public class AppUserLocationLog implements Serializable {
