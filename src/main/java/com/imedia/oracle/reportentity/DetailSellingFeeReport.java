...
public class DetailSellingFeeReport implements Serializable {
    ...
    public DetailSellingFeeReport() {
    }

    public DetailSellingFeeReport(String code, String name, BigDecimal orderDetailCode, BigDecimal value) {
        this.code = code;
        this.name = name;
