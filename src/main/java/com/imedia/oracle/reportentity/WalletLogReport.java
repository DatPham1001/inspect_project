...
@SqlResultSetMapping(
        name = "FilterWalletLogMapping",
        classes = {
                @ConstructorResult(
                        targetClass = FilterWalletLogDataResponse.class,
                        columns = {
                                ...
                                @ColumnResult(name = "CHANGE_BASE", type = BigDecimal.class),
                                ...
                                @ColumnResult(name = "TO_BASE", type = BigDecimal.class),
                                @ColumnResult(name = "ORDER_DETAIL_ID", type = String.class),
                        }
                )
        }
)
public class WalletLogReport implements Serializable {
